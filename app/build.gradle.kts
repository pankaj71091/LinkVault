...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 37
        versionCode = 1
        versionName = "0.7.0" // Phase 0-4 + 4.5 batches 1&2 (tags, archive, pin, notes, sort, search, duplicate detection, auto-suggest folder, custom folder colors) — schema v2, no new migration this batch
